...
<head>
  ...
  <title>Kawal Corona - Project</title>
  ...
  <link href="{{asset('frontend/assets/vendor/icofont/icofont.min. ')}}" rel="stylesheet">
  <link href="{{asset('frontend/assets/vendor/boxicons/boxicons.min.css ')}}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a href="{{asset('welcome.blade.php')}}">Kawal Corona</a></h1>
          ...
          <li>
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                      <li>
                        <a href="{{ url('/home') }}" class="text-sm text-gray-700 underline"><h4 class="text-light">HOME</h4></a>
                      </li>
                    {{-- @else
                    <li>
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 underline"><h4 class="text-light">LOGIN</h4></a>
                    </li> --}}
                        {{-- @if (Route::has('register'))
                        <li>
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline"><h4 class="text-light">REGISTER</h4></a>
                        </li>
                        @endif --}}
                    @endauth
                </div>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Kawal Corona</h1>
          <h2>Project PKL WEB</h2>
        </div>
        {{-- <div class="col-xl-4 col-lg-6 order-1 order-lg-2 cona" data-aos="zoom-in" data-aos-delay="150">
          <img src="{{asset('frontend/assets/img/cona.png ')}}" class="img-fluid animated" alt="">
        </div> --}}
      </div>
    </div>
    </div>
  ...
  <main id="main">
    ...
    <section class="counts">
      <div class="container">
        <div class="row counters section-title">
          <h2 class="text-light">INDONESIA</h2>
  ...
  <div class="card-header ">
    <section class="showcase">
      <div class="container-fluid">
        ...
        <div class="col-lg-10">
          <div class="card">
            <div class="card-header">Data Kasus Corona Virus Berdasarkan Global</div>
            <div class="card-body">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="image col-lg-6 order-1 order-lg-2 " data-aos="zoom-in" data-aos-delay="100">
            <img src="{{asset('frontend/assets/img/features.svg ')}}" alt="" class="img-fluid">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Bandung<br>
              lk <br><br>
              <strong>Phone:</strong> 083822000504<br>
              <strong>Email:</strong> are@gmail.com.com/ <br>
            </p>
          </div>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>KawalCorona</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
  ...
  <a href="#" class="back-to-top"><i class="icofont-simple-up">up</i></a>
