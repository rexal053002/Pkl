                ...
                <div class="card-body">
                    ...
                    <tbody>
                         ...
                         @foreach($kelurahan as $data)
                            <tr>
                                <th scoppe="row">{{$no++}}</th>
                                <td class="text-center">{{$data->kecamatan->nama_kecamatan}}</td>
                                <td class="text-center">{{$data->nama_kelurahan}}</td>
                                <td><form action="{{route('kelurahan.destroy',$data->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{route('kelurahan.show',$data->id)}}" class="float-right btn btn-outline-primary">Show</a>
